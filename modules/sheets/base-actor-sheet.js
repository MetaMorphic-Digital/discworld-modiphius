 ...
 */
export default class DiscworldActorSheet extends HandlebarsApplicationMixin(
  ActorSheetV2,
) {
  static DEFAULT_OPTIONS = {
    ...
    actions: {
      editImage: DiscworldActorSheet.#onEditImage,
    },
  };
  ...
  /*    (all taken from Zhell's Artichron code)     */
  /* ---------------------------------------------- */
